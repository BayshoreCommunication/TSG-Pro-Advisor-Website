...
export default function ServicesSection() {
  return (
    <section className="relative w-full bg-white overflow-hidden">
      {/* TOP CONTENT */}
      <div className="max-w-[1640px] mx-auto px-8 py-8 md:py-16 mb-32">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-10 md:gap-64 text-center place-items-center">
            {/* <Reveal x={100} opacityFrom={0} duration={3}>
    <div className="max-w-[500px] flex flex-col justify-center items-center  md:mt-16">
        ...
        LEARN MORE
            ...
            <Reveal x={100} opacityFrom={0} duration={3}>
              <div className="max-w-[500px] flex flex-col justify-center items-center">
                ...
                <p className="text-gray-600 text-sm mb-4 text-center">
                  Use fast, accurate, and reliable tax software that supports
                  your workflow.
                </p>
                <button className="text-[#F16128] font-semibold text-sm">
                  LEARN MORE
            ...
            <Reveal x={100} opacityFrom={0} duration={3}>
              <div className="max-w-[500px] flex flex-col justify-center items-center ">
                ...
                <p className="text-gray-600 text-sm mb-4 text-center">
                  Get guidance to streamline your process and grow your
                  business.
                </p>
                <button className="text-[#F16128] font-semibold text-sm">
                  LEARN MORE

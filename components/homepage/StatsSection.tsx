...
export default function StatsSection() {
  ...
  return (
    <section className="relative py-8 md:py-16 px-8 w-full bg-gray-50">
      {/* Background Image */}
      ...
      <div className="max-w-[1640px] mx-auto text-center">
        ...
        <p className="max-w-3xl mx-auto mt-4 text-gray-600">
          Whether you are starting a tax business or improving an existing one,
          TSG ProAdvisor gives you the training and guidance to help you move

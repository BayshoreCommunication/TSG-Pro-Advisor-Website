        ...
        <div className="flex flex-col items-center text-center gap-6">
          ...
          <Reveal y={80} opacityFrom={0} duration={1.6}>
            <div className="px-6 lg:px-10 rounded-2xl">
              <h1 className="text-5xl lg:text-[80px] font-semibold text-transparent leading-snug md:leading-none arya-font max-w-5xl text-white">
                {displayedText}
          ...
          <Reveal y={80} opacityFrom={0} duration={2.2}>
            ...
            >
              <span className="relative z-10">Connect with TSG ProAdvisor</span>

        ...
        <Reveal y={100} opacityFrom={0} duration={3}>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch ">
            <div className=" rounded-2xl text-white h-full">
              <div className="p-5 lg:p-8 bg-[#4E4E4E] bg-[linear-gradient(180deg,rgba(217,217,217,0.3)_0%,rgba(242,100,34,0.3)_100%)] flex flex-col gap-3 rounded-2xl h-full justify-between ">
                <div>
                  <h4 className="text-2xl lg:text-4xl font-semibold border-b-1 border-white pb-4 mb-3">
                    <span className="text-primary">TSG</span> ProAdvisor
                    Services
                  </h4>
                  <p>
                    TSG ProAdvisor offers Tax & Accounting Education,
                    Professional Tax Software, and Business Mentorship designed
                    to help you start or grow your business. Whether you’re
                    launching a new venture or scaling an existing one, you get
                    training, tools, and guidance that support your success.
                  </p>
                </div>
                <Link
                  href="/contact"
                ...
                flex justify-center  overflow-hidden group
